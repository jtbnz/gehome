...
_configuration = [
    ...
    ErdConfigurationEntry(ErdCode.WH_HEATER_BOOST_MODE, ErdWaterHeaterModeConverter(), ErdCodeClass.WATERHEATER_SENSOR),
    ErdConfigurationEntry(ErdCode.WH_HEATER_BOOST_STATE, ErdWaterHeaterModeConverter(), ErdCodeClass.WATERHEATER_SENSOR),
